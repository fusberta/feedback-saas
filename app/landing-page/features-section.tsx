...
const features = [
  ...
  {
    title: 'Customizable',
    description: 'Customize Fedx to fit your needs and preferences.',
    icon: 'icon-2',
  },
  {
    title: 'Analytics',
  ...
  {
    title: 'Secure',
    description: 'Your data is safe and secure with Fedx.',
  },
  {
    title: 'Scalable',
    description: 'Grow your business with Fedx as you scale.',
  },
  {
    title: 'Fast Support',
